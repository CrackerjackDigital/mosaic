Mosaic.prototype.badger = function (options, mosaic) {
    var badges = {
    ...
    this.ui.badger = new function() {
        // add is on badger
        this.add = function (name, config) {
            var badges = this,
                badgeDefaults = (mosaic.config.badger && mosaic.config.badger.defaults) || {},
                options = $.extend({}, badgeDefaults, config),
                ...
                // badgeHTML = TODO complete html customisation
                ;
        ...
        this.remove = function(name) {
            var badgeDefaults = (mosaic.config.badger && mosaic.config.badger.defaults) || {},
                options = $.extend({}, badgeDefaults, config),
                $element = $(options.element),
                tokens = {
                    name: name
